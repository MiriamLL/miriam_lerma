...
icon_link(icon = "fas fa-images",
          text = "Open",
          url = "https://miriamll.github.io/teaching_R/DataWrangling_0805.html#1")
```
...
To download the presentation as pdf click [here](https://github.com/MiriamLL/data_supporting_webpage/blob/main/Teaching/DataWrangling.pdf).
