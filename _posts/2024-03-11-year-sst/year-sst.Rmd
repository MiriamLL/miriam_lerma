...
For obtaining data, download sea surface temperature (SST) from **erdMW1sstd1day** ([link here](https://upwell.pfeg.noaa.gov/erddap/griddap/erdMWsstd1day.graph?sst%5B(2024-02-17T12:00:00Z)%5D%5B(0.0)%5D%5B(22.0):(51.0)%5D%5B(205.0):(255.0)%5D&.draw=surface&.vars=longitude%7Clatitude%7Csst&.colorBar=%7C%7C%7C%7C%7C&.bgColor=0xffccccff&.click=?302,181))

```{r}
sstInfo <- info('erdMWsstd1day')
```
...
To download chlorophyll concentration (CHL) data, connect to **erdMW1CHLd1day** (here the [link](https://upwell.pfeg.noaa.gov/erddap/griddap/erdMWcflh3day.graph))
...
For the average use functions from the package **tidyverse**
