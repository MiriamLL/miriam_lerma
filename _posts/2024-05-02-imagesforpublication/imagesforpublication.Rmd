---
title: "Add text on images using R"
description: |
...
Give the file path as **My_directory**.  
Check if you gave the correct path by using the function **list.files**.  
It should show the images you want to use.  

```{r, echo=FALSE}
library(here)
My_directory<-here('C://Users//lerma//OneDrive//Documents//03Academico//02Proyectos-Postdoc//2024//1Programming//1Distill//Distill//_posts//2024-05-02-imagesforpublication')
```
...
image_write(Fig2_text, path = paste0(My_directory,"/Fig2_lt.png"), format = "png")
```

## Combine

Read the two modified pictures. 
