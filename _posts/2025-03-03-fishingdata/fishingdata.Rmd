...
To download test data in tif format [click here](https://github.com/MiriamLL/TestData/blob/main/public-global-fishing-effort-v3.0.tif).  
...
```{r}
Fishing_tif<-"https://github.com/MiriamLL/TestData/raw/refs/heads/main/public-global-fishing-effort-v3.0.tif"
```
...
```{r}
Fishing_csv<-"https://github.com/MiriamLL/TestData/raw/refs/heads/main/layer-activity-data-0/public-global-fishing-effort-v3.0.csv"
```
