...
To subset the data we can use the function **filter** from the package tidyverse.

```{r}
library(tidyverse)
```

Here I define longitude and latitude limits of my interest.
...
Here I check briefly the average Fishing Effort for the area. 
