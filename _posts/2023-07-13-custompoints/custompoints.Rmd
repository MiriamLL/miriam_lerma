...
Define how many classes you want to use and where the cuts will be made
...
The sizes are also defined by numbers.
...
To add text on the label we can use characters.
...
Since we need reference, to add a base map, the package **sf** contains the function **geom_sf** and the package **GermanNorthSea** contains shapefiles from the North Sea that allows to create a base map.
