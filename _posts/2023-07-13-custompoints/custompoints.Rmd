...
Assign factors  
Using the function **mutate** form the package **tidyverse** add new column with a classification.  
...
Check number of observations just to make sure your classification was working and that you have at least one value per group.
...
To define shapes create a vector define shapes
