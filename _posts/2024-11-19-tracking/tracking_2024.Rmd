...
In this post, you'll find a curated collection of my blog posts focused on tracking analysis from loading the data and data cleaning to visualizations.
...
These selected materials offer valuable insights and information on a variety of topics for further learning.

Note that technology is advancing rapidly, and some of the scripts rely on functions that are already deprecated.  
New packages are being developed each year.  
...
I prefer to write my own scripts, particularly when addressing specific questions. If you need help or a custom script, feel free to reach out to me.
