...
description: |
  A a curated collection of my blog posts focused on animal tracking analysis.
author:
  - name: Miriam Lerma
    url: {}
date: 2024-11-19
...
In this post, you'll find a curated collection of my blog posts focused on tracking analysis. Each entry delves into different aspects of tracking, from data collection to interpretation, providing valuable insights and practical tips for anyone looking to enhance their tracking techniques and understanding.

**Load data**  
- [From movebank](https://miriamll.github.io/R_intro/Tracking_0606.html#4)  
- [From csv](https://miriamll.github.io/R_intro/Tracking_0606.html#20)  

**Data preparation**  
- [Usage of time formats](https://www.miriam-lerma.com/posts/2022-06-30-time-formats/)  
- [Converting times](https://miriamll.github.io/R_intro/Tracking_0606.html#36)  
...
**Clean**   
- [Select columns](https://miriamll.github.io/R_intro/Tracking_0606.html#30)  
...
- [Export clean data frame](https://miriamll.github.io/R_intro/Tracking_0606.html#34)  
...
**Visualizations**  
- [Plot basics](https://miriamll.github.io/R_intro/Tracking_0606.html#40)  
...
Below, you'll find a list of recommended sources to explore. These selected materials offer valuable insights and information on a variety of topics, providing a solid foundation for further learning.

Note that technology is advancing rapidly, and some of the scripts rely on functions that are already deprecated. 
Moreover, new packages are being developed each year.
...
**2023**  
- My [teaching materials](https://www.miriam-lerma.com/posts/2023-06-06-tracking/)
...
I personally enjoy creating my own scripts, especially when I need to address specific questions. If you require assistance or custom scripts, don't hesitate to get in touch with me.
