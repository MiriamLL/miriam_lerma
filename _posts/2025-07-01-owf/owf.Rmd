...
description: |
  This blog post shows how to visualize data on offshore wind farms in the German North Sea using R. It covers downloading the dataset from EMODnet, exploring the data, and creating a map with ggplot2. In addition, it shows an example on how to calculate the area developed before 2016, highlighting the rapid growth of offshore wind farms (OWFs). Moreover, it includes some references on their potential impacts on marine animals.
author:
  - name: Miriam Lerma
    url: {}
date: 2025-07-01
preview: owf_portada.jpg
output:
...
<body>
   <left>
      <a href="https://github.com/MiriamLL/miriamlerma_/blob/main/_posts/2025-07-01-owf/Alpha_Ventus_Windmills_wikipedia.JPG?raw=true"><img src="https://github.com/MiriamLL/miriamlerma_/blob/main/_posts/2025-07-01-owf/Alpha_Ventus_Windmills_wikipedia.JPG?raw=true" style="width:450px"></a>
   </left>
</body>
</html>
...
OWF_1plot<-ggplot(OWF_EMODnet) + # Gives CRS
  ...
  ## OWF
  geom_sf(data = OWF_After2016,  colour = NA,fill= "white",alpha=1, size=1,linetype="dashed")+  
...
```{r}
(sum(OWF_After2016$AREA_SQKM)*100)/(sum(OWF_Before2016$AREA_SQKM,OWF_After2016$AREA_SQKM))
```
...
**GeoSeaPortal** is a comprehensive geodata infrastructure that provides both internal and external users with access to spatial data related to Germany's seas and coasts. The platform integrates data from various sources into a geo-object-relational database, ensuring harmonisation and facilitating efficient data retrieval and visualisation. 
...
**Further reading** <br>
[IUCN](https://portals.iucn.org/library/sites/library/files/documents/2024-037-En_0.pdf)
