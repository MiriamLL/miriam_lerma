...
title: "Land or not"
description: |
  How to identify if your animal is on land or not.
author:
  - name: Miriam Lerma
    url: {}
date: 2022-04-07
...
It depends on the information of your polygon, but in this particular example, in the column NAME_0, if the points fall inside the polygon, then it keeps Chile otherwise returns an **NA**.  
...
To make it easier to understand, replace according to the data available in your polygon. 
...
Plotting the data will help to confirm if the classification makes sense. 
...
To customize your plot, change the **theme_bw** see here for [other options](https://ggplot2.tidyverse.org/reference/ggtheme.html).  
