...
```{r, fig.height=2,echo=FALSE, fig.align='left'}
knitr::include_graphics("https://geocompr.robinlovelace.net/05-geometry-operations_files/figure-html/circle-intersection-1.png")
```
...
To calculate the shared area, the function follows the formula as in  [Hedd et al. 2014](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0194389#sec002)
...
- [Shared areas formula by Hedd et al. 2018](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0194389#sec002)