...
To download test data in tif format [click here](https://github.com/MiriamLL/miriamlerma_/raw/refs/heads/main/_posts/2025-05-18-lightpollution//viirs_npp_202300b.tif).  
...
Select [CRS: Coordinate Reference System](https://www.crs-geo.eu/crs-national.htm).  EPSG(European Petroleum Survey Group)[]
...
ggplot() +
  ...
  coord_sf(default_crs = sf::st_crs(32612))+
  NULL
```
