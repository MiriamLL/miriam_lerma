...
To download test data in tif format [click here](https://github.com/MiriamLL/TestData/blob/main/viirs_npp_202300b.tif).  

Select the directory where the information is stored, or as here, use the data directly form the repository. 

```{r}
Light_pollution_tif<-'https://github.com/MiriamLL/TestData/raw/refs/heads/main/viirs_npp_202300b.tif'
```
