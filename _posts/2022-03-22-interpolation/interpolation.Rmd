...
In case you want to interpolate a specific trip, or everything, and you already have a datetime column in the correct format (so R can understand is date and time) there is also the function **interpolate** in the package **sula**

For example, interpolate a specific trip
