...
```{r}
DistCoast_tif<-"https://github.com/MiriamLL/data_supporting_webpage/raw/refs/heads/main/Blog/2025/FishingWatch/public-global-fishing-effort-v3.0.tif"
```
...
```{r, eval=FALSE}
library(terra)
DistCoast_file<-rast(DistCoast_tiff)
```
