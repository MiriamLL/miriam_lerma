...
When analyzing tracking data in R, you may want to explore the locations. One option is to export the cleaned dataset as a CSV and open it in QGIS. However, R also offers interactive mapping features. In this post, I’ll walk you through the steps I used to create interactive maps with my GPS data.
...
The function **fortify** turns a map into a data frame that can more easily be plotted.
