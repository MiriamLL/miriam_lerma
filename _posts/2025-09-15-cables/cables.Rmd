...
<body>
   <left>
      <a href="https://ychef.files.bbci.co.uk/1600x900/p0jxm9xs.webp" style="width:450px"></a>
      <img src="https://www.sa-world.com/images/econa-article-images/260/full/Untitled%20design(72).jpg" style="width:450px"></a>
   </left>
</body>
</html>
Image from: [BBC](https://www.bbc.co.uk/future/article/20241014-the-deep-sea-emergency-service-that-keeps-the-internet-running)
...
Image from Germany Mecklenburg-Western Pomerania Baltic Sea – undersea cable to Hiddensee island. Source [Energy Industry Review](https://energyindustryreview.com/wp-content/uploads/2022/03/submarin-cable-layout.jpg)
...
To have easier access to the files, save them in the same directory and provide the directory where the data is stored.
...
There are around 1.4 million kilometers (870,000 miles) of telecommunication cables lining the seafloor, connecting every ocean across the globe. Laid end to end, they could stretch across the diameter of the Sun, and they carry an astounding 99% of the world’s digital data. Yet for something so vital, these cables are surprisingly slim, often just 2 cm thick, roughly the width of a garden hose.
Source: [BBC](https://www.bbc.co.uk/future/article/20241014-the-deep-sea-emergency-service-that-keeps-the-internet-running)

```{r,echo=FALSE, include=FALSE}
This_directory<-"C:\\Users\\lerma\\OneDrive\\Documents\\03Academico\\02Proyectos-Postdoc\\2025\\1Programming\\1Distill\\data_supporting_webpage\\Blog//2025//Cables\\"
...
Load base shapefiles from the package GermanNorthSea. 
...
Telecommunications in Germany connect UK, Netherlands, Denmark and Norway. 
...
Base_map +
  ...
  geom_richtext(aes(x =  2.9, y = 56.0,
  label = "<span style='color:#adb5bd'>Underwater Telecommunication Cables crossing  <br> 
  the German North Sea.  <br>
  Data source from: <span style='color:#8ac926'>Netherlands</span>, 
  <span style='color:#c86bfa'>France</span> and 
  <span style='color:#ffd60a'>Germany</span>."), 
  size = 4,fill ="black",label.color = NA,  hjust = 0,  vjust= 0,  inherit.aes = TRUE
  )+
...
SEA-ME-WE 3 (South-East Asia – Middle East – Western Europe 3) is the world’s longest optical submarine telecommunications cable, linking Asia, the Middle East, and Europe. Source: [Wikipedia](https://en.wikipedia.org/wiki/SEA-ME-WE_3)
...
The relevant files for the power lines in the German North Sea are in the files from German, Netherland and Norway cables.
...
Power_cables<-Base_map +
  ...
  size = 8,fill ="black",label.color = NA,  hjust = 0,  vjust= 0,  inherit.aes = TRUE
  )
Power_cables
```
...
Cables<-Base_map +
  ...
  coord_sf(ylim = c(53,56.4), xlim = c(3,9),
                    label_axes = list(left = "N", bottom = 'E'))
Cables_wtext<-Cables+
  geom_richtext(aes(x = 2.7, y = 56.0,
label =  "<span style='color:#adb5bd'>  Undersea Cables crossing the German North Sea.</span>\n
<span style='color:#adb5bd'>  Power cable  (in dashed lines) data source from: 
<span style='color:#ff595e'>Netherlands</span>, 
<span style='color:#ff924c'>Norway</span> and 
<span style='color:#ffca3a'>Germany</span>.</span> \n
<span style='color:#adb5bd'>  Telecommunications cable (in solid lines) data source from: 
<span style='color:#8ac926'>Netherlands</span>, 
<span style='color:#c86bfa'>France</span> and 
<span style='color:#ffd60a'>Germany</span>.</span>"),  
  size = 7, fill = "black", label.color = "black", hjust = 0, vjust = 0
)
Cables_wtext
```
...
<span style='color:#c86bfa'>France</span> and 
<span style='color:#ffd60a'>Germany</span>.</span>"),  
  size = 10, fill = "black", label.color = "black", hjust = 0, vjust = 0
),
...
**Telecommuncations**  
- [Ocean Cables Map](https://www.nytimes.com/interactive/2019/03/10/technology/internet-cables-oceans.html)<br>
- [Submarine networks](https://www.submarinenetworks.com/en/systems/intra-europe/ioema/ioema-fibre-to-build-submarine-cable-connecting-five-northern-european-markets)<br>
...
- [How do the submarine cables get installed - Video](https://youtu.be/Gg1aFmsKQgk)<br>
