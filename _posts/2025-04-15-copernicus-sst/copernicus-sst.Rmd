---
title: "Plot sea surface temperature in R"
description: |
...
To download raster data: 
[Copernicus Marine Data Store](https://marine.copernicus.eu/about)

To download data [visit webpage](https://data.marine.copernicus.eu/products)  
...
To read the data give the direction of your file.  

```{r, include=FALSE}
library(here)
here()
this_folder<-paste0(here(),"/_posts/2025-04-15-copernicus-sst")
...
To select different palettes explore [ggplot2 book](https://ggplot2-book.org/scales-colour)  

Here are some of the palette options

```{r, echo=FALSE, out.width = "80%"}
knitr::include_graphics("https://ggplot2-book.org/scales-colour_files/figure-html/unnamed-chunk-23-1.png")
```

To add the palette use **scale_fill_distiller**
...
For reference, add land shapefiles
