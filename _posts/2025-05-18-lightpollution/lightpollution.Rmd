...
Download data are available at [Light pollution map](https://www.lightpollutionmap.info/#zoom=3.32&lat=48.8875&lon=2.7774&state=eyJiYXNlbWFwIjoiTGF5ZXJCaW5nUm9hZCIsIm92ZXJsYXkiOiJ2aWlyc18yMDE3Iiwib3ZlcmxheWNvbG9yIjpmYWxzZSwib3ZlcmxheW9wYWNpdHkiOjYwLCJmZWF0dXJlc29wYWNpdHkiOjg1fQ==)  
- By selecting the icons of the tools, then the square.  
...
```{r, message=FALSE}
library(here)
your_folder<-paste0(here(),"/_posts/2025-05-18-lightpollution")
#your_folder
...
Use the function **geom_raster** to plot the radiance data.

```{r, fig.width=8, fig.height=6}
ggplot() +
  geom_raster(data = Light_pollution_radiance, aes(x = x, y = y, fill = radiance)) +
...
ggplot() +
  ...
  coord_sf(xlim = c(5,9), ylim = c(53,56),
                    label_axes = list(top = "E", left = "N", bottom = 'E', right='N'))+
  theme_void()+
    theme(legend.background = element_rect(colour = "transparent", fill = "transparent"),
        legend.position = c(0.40,0.60),
...
ggplot() +
  ...
  theme_void()+
    theme(legend.background = element_rect(colour = "transparent", fill = "transparent"),
        ...
        legend.text=element_text(color='#f9c74f',size=12),
        legend.title=element_text(color='#f9c74f',size=12))+
  annotate("text", x = 7.885143539318454+0.06, y = 54.181291760152874,
