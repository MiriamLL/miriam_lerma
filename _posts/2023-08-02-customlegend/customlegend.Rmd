...
Here is too add the title of the legend. 
...
This function is also available in the package **seamonas**, but I am including it here in case you want to customize it.

It changes the x and y axis legends to Capitalized words and includes the symbol of degree on the plot.
Removes the gray background and adds a white line on the panel border. 
...
To run the function just add your plot following plot_wlegend
